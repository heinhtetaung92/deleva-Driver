...
public class AvaliableJobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public AvaliableJobRecyclerAdapter(Context context, String location, List<JobItem> items, View headerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof ItemViewHolder) {
            ...
            //((ItemViewHolder) viewHolder).jobtype.setText(mItems.get(position -1).get_requester_name());
    ...
    public void onClick(View v) {
        ...
        if(v.getTag() != null){
            ...
            Intent intent = new Intent(mContext, AvaliableJobDetailActivity.class);
